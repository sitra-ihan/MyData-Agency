...
exports.isConnectionRequest = async function(type) {
  return (
...
exports.acceptRequest = async function(
  ...
  let meta = JSON.stringify({
    ...
    verified: true // Indicates that the owner of the agent has confirmed they want to stay connected with this person.
  });
  ...
  let connectionResponse = {
    organizationName: config.userInformation.orgname,
    did: myDid,
    verkey: myVerkey,
    nonce: requestNonce
  };
