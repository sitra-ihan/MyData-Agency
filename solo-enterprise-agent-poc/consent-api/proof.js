...
module.exports = {
    ...
    create_self_proof: async function create_self_proof(request_entry, cred_issuer_did) {
        try {
            let myEndpointDID = await indy.did.getEndpointDid();
            let resp = await indy.proofs.createSelfProof(myEndpointDID, cred_issuer_did, request_entry);
            return {
                "status": "success",
                "proof": resp
            };
